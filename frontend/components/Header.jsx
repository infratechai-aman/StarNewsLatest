        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center cursor-pointer group" onClick={() => setCurrentView('home')}>
              <div className="flex-shrink-0 h-20 md:h-24 w-[240px] md:w-[270px] bg-white/95 backdrop-blur-sm rounded-md shadow-md p-[3px] group cursor-pointer relative z-20 border border-gray-100">
